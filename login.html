...
<html lang="en">
    ...
    <script>
      ...
      /*  new Vue({
            ...
            methods:{
                onSubmit:function(){
                    this.$http.post('http://localhost:8080/Sistemas/Hotel/Login/validate',this.info).then(function(response){
                       if(response.body.val == 'true'){
                           window.location = "http://localhost:8080/Sistemas/Hotel/Inicio" ;
                       }else{
